...
(
    rating_id  INT      NULL     AUTO_INCREMENT COMMENT '평가의 고유 식별자',
    ...
    created_at DATETIME NULL     DEFAULT CURRENT_TIMESTAMP COMMENT '강의 ID에 대한 외래 키',
    PRIMARY KEY (rating_id)
) COMMENT '사용자의 강의 평가 정보를 저장하는 테이블';

CREATE TABLE COURSE_SESSIONS
(
    session_id INT          NULL     AUTO_INCREMENT COMMENT '세션의 고유 식별자',
...
(
    course_id     INT          NULL     AUTO_INCREMENT COMMENT '강의의 고유 식별자',
